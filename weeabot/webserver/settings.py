...
"""
Django settings for weeabot.webserver project.
...
SECRET_KEY = 'u1@_d&y+#sl*$yhywowka_jumopua0i_(3q!sko1a7o#k#p^l^'
...
DB_PATH = '/.weeabot'
HOME = expanduser("~")
DATABASE_DIRECTORY = HOME+DB_PATH
if not os.path.exists(DATABASE_DIRECTORY):
  os.makedirs(DATABASE_DIRECTORY)
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': os.path.join(DATABASE_DIRECTORY, 'db.sqlite3'),
    }
}
